...
public class plantas_Alarmas extends JFrame implements ActionListener{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					plantas_Alarmas frame = new plantas_Alarmas();
	...
	public plantas_Alarmas() {
		...
		Alarmas2.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
            	//Close actual frame and open another one
            	plantas_Alarmas Planta2 = new plantas_Alarmas();
