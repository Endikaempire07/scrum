...
public class planta_baja_calefaccion extends JFrame implements ActionListener{
	...
	public planta_baja_calefaccion() {
		...
		sl_p.putConstraint(SpringLayout.WEST, btnMenu_pbc, 0, SpringLayout.WEST, btnET);
		sl_p.putConstraint(SpringLayout.SOUTH, btnMenu_pbc, -6, SpringLayout.NORTH, btnET);
		sl_p.putConstraint(SpringLayout.WEST, btnET, 36, SpringLayout.WEST, p);
		sl_p.putConstraint(SpringLayout.SOUTH, btnET, -84, SpringLayout.SOUTH, p);
		p.add(btnET);

		btnAT = new JButton("Apagar todo");
		sl_p.putConstraint(SpringLayout.NORTH, btnAT, 10, SpringLayout.SOUTH, btnET);
		sl_p.putConstraint(SpringLayout.WEST, btnAT, 0, SpringLayout.WEST, btnET);
		p.add(btnAT);
		...
		btnC1.setIcon(new ImageIcon(planta_baja_calefaccion.class.getResource("/imagenes/calefaccion.png")));
		...
		sl_p.putConstraint(SpringLayout.WEST, lbl1, 0, SpringLayout.WEST, btnMenu_pbc);
		sl_p.putConstraint(SpringLayout.SOUTH, lbl1, -146, SpringLayout.NORTH, btnMenu_pbc);
...
//		p.add(lbl2);
		...
		sl_p.putConstraint(SpringLayout.WEST, lbl3, 0, SpringLayout.WEST, btnMenu_pbc);
		sl_p.putConstraint(SpringLayout.SOUTH, lbl3, -130, SpringLayout.NORTH, btnMenu_pbc);
		...
		btnC2.setIcon(new ImageIcon(planta_baja_calefaccion.class.getResource("/imagenes/calefaccion.png")));
		...
		sl_p.putConstraint(SpringLayout.WEST, lbl4, 0, SpringLayout.WEST, btnMenu_pbc);
		sl_p.putConstraint(SpringLayout.SOUTH, lbl4, -115, SpringLayout.NORTH, btnMenu_pbc);
		...
		btnC3.setIcon(new ImageIcon(planta_baja_calefaccion.class.getResource("/imagenes/calefaccion.png")));
		...
		sl_p.putConstraint(SpringLayout.WEST, lbl5, 0, SpringLayout.WEST, btnMenu_pbc);
		sl_p.putConstraint(SpringLayout.SOUTH, lbl5, -100, SpringLayout.NORTH, btnMenu_pbc);
		...
		btnC4.setIcon(new ImageIcon(planta_baja_calefaccion.class.getResource("/imagenes/calefaccion.png")));
		...
		sl_p.putConstraint(SpringLayout.WEST, lbl6, 0, SpringLayout.WEST, btnMenu_pbc);
		sl_p.putConstraint(SpringLayout.SOUTH, lbl6, -85, SpringLayout.NORTH, btnMenu_pbc);
		...
		btnC5.setIcon(new ImageIcon(planta_baja_calefaccion.class.getResource("/imagenes/calefaccion.png")));
		...
		sl_p.putConstraint(SpringLayout.WEST, lbl7, 0, SpringLayout.WEST, btnMenu_pbc);
		sl_p.putConstraint(SpringLayout.SOUTH, lbl7, -70, SpringLayout.NORTH, btnMenu_pbc);
		...
		btnC6.setIcon(new ImageIcon(planta_baja_calefaccion.class.getResource("/imagenes/calefaccion.png")));
		...
		sl_p.putConstraint(SpringLayout.WEST, lbl8, 0, SpringLayout.WEST, btnMenu_pbc);
		sl_p.putConstraint(SpringLayout.SOUTH, lbl8, -55, SpringLayout.NORTH, btnMenu_pbc);
		...
		btnC7.setIcon(new ImageIcon(planta_baja_calefaccion.class.getResource("/imagenes/calefaccion.png")));
		...
		sl_p.putConstraint(SpringLayout.WEST, lbl9, 0, SpringLayout.WEST, btnMenu_pbc);
		sl_p.putConstraint(SpringLayout.SOUTH, lbl9, -40, SpringLayout.NORTH, btnMenu_pbc);
		...
		btnC8.setIcon(new ImageIcon(planta_baja_calefaccion.class.getResource("/imagenes/calefaccion.png")));
		...
		sl_p.putConstraint(SpringLayout.WEST, lbl10, 0, SpringLayout.WEST, btnMenu_pbc);
		sl_p.putConstraint(SpringLayout.SOUTH, lbl10, -25, SpringLayout.NORTH, btnMenu_pbc);
		...
		btnC9.setIcon(new ImageIcon(planta_baja_calefaccion.class.getResource("/imagenes/calefaccion.png")));
		...
		sl_p.putConstraint(SpringLayout.WEST, lbl11, 0, SpringLayout.WEST, btnMenu_pbc);
		sl_p.putConstraint(SpringLayout.SOUTH, lbl11, -10, SpringLayout.NORTH, btnMenu_pbc);
		...
		btnC10.setIcon(new ImageIcon(planta_baja_calefaccion.class.getResource("/imagenes/calefaccion.png")));
		...
		sl_p.putConstraint(SpringLayout.WEST, lbl12, 85, SpringLayout.WEST, btnMenu_pbc);
		sl_p.putConstraint(SpringLayout.SOUTH, lbl12, -145, SpringLayout.NORTH, btnMenu_pbc);
		...
		btnC11.setIcon(new ImageIcon(planta_baja_calefaccion.class.getResource("/imagenes/calefaccion.png")));
		...
		sl_p.putConstraint(SpringLayout.WEST, lbl13, 85, SpringLayout.WEST, btnMenu_pbc);
		sl_p.putConstraint(SpringLayout.SOUTH, lbl13, -130, SpringLayout.NORTH, btnMenu_pbc);
		...
		btnC12.setIcon(new ImageIcon(planta_baja_calefaccion.class.getResource("/imagenes/calefaccion.png")));
		...
		sl_p.putConstraint(SpringLayout.WEST, lbl14, 85, SpringLayout.WEST, btnMenu_pbc);
		sl_p.putConstraint(SpringLayout.SOUTH, lbl14, -115, SpringLayout.NORTH, btnMenu_pbc);
		...
		btnC13.setIcon(new ImageIcon(planta_baja_calefaccion.class.getResource("/imagenes/calefaccion.png")));
		...
		sl_p.putConstraint(SpringLayout.WEST, lbl15, 85, SpringLayout.WEST, btnMenu_pbc);
		sl_p.putConstraint(SpringLayout.SOUTH, lbl15, -100, SpringLayout.NORTH, btnMenu_pbc);
		...
		btnC14.setIcon(new ImageIcon(planta_baja_calefaccion.class.getResource("/imagenes/calefaccion.png")));
		...
		sl_p.putConstraint(SpringLayout.WEST, lbl16, 85, SpringLayout.WEST, btnMenu_pbc);
		sl_p.putConstraint(SpringLayout.SOUTH, lbl16, -85, SpringLayout.NORTH, btnMenu_pbc);
		...
		btnC15.setIcon(new ImageIcon(planta_baja_calefaccion.class.getResource("/imagenes/calefaccion.png")));
		...
		sl_p.putConstraint(SpringLayout.WEST, lbl17, 85, SpringLayout.WEST, btnMenu_pbc);
		sl_p.putConstraint(SpringLayout.SOUTH, lbl17, -70, SpringLayout.NORTH, btnMenu_pbc);
		...
		btnC16.setIcon(new ImageIcon(planta_baja_calefaccion.class.getResource("/imagenes/calefaccion.png")));
		...
		sl_p.putConstraint(SpringLayout.WEST, lbl18, 85, SpringLayout.WEST, btnMenu_pbc);
		sl_p.putConstraint(SpringLayout.SOUTH, lbl18, -55, SpringLayout.NORTH, btnMenu_pbc);
		...
		btnC17.setIcon(new ImageIcon(planta_baja_calefaccion.class.getResource("/imagenes/calefaccion.png")));
		...
		sl_p.putConstraint(SpringLayout.WEST, lbl19, 85, SpringLayout.WEST, btnMenu_pbc);
		sl_p.putConstraint(SpringLayout.SOUTH, lbl19, -40, SpringLayout.NORTH, btnMenu_pbc);
		...
		btnC18.setIcon(new ImageIcon(planta_baja_calefaccion.class.getResource("/imagenes/calefaccion.png")));
		...
		sl_p.putConstraint(SpringLayout.WEST, lbl20, 85, SpringLayout.WEST, btnMenu_pbc);
		sl_p.putConstraint(SpringLayout.SOUTH, lbl20, -25, SpringLayout.NORTH, btnMenu_pbc);
		...
		btnC19.setIcon(new ImageIcon(planta_baja_calefaccion.class.getResource("/imagenes/calefaccion.png")));
		...
		sl_p.putConstraint(SpringLayout.WEST, lbl21, 85, SpringLayout.WEST, btnMenu_pbc);
		sl_p.putConstraint(SpringLayout.SOUTH, lbl21, -10, SpringLayout.NORTH, btnMenu_pbc);
		lbl21.setForeground(Color.RED);
		lbl21.setBounds(32, 245, 112, 13);
		p.add(lbl21);

		JButton btnC20 = new JButton("");
		sl_p.putConstraint(SpringLayout.WEST, btnC20, 380, SpringLayout.EAST, btnMenu_pbc);
		...
		btnC20.setIcon(new ImageIcon(planta_baja_calefaccion.class.getResource("/imagenes/calefaccion.png")));
		...
		sl_p.putConstraint(SpringLayout.WEST, lbl22, 170, SpringLayout.WEST, btnMenu_pbc);
		sl_p.putConstraint(SpringLayout.SOUTH, lbl22, -145, SpringLayout.NORTH, btnMenu_pbc);
		...
		btnC21.setIcon(new ImageIcon(planta_baja_calefaccion.class.getResource("/imagenes/calefaccion.png")));
		...
		sl_p.putConstraint(SpringLayout.WEST, lbl23, 170, SpringLayout.WEST, btnMenu_pbc);
		sl_p.putConstraint(SpringLayout.SOUTH, lbl23, -130, SpringLayout.NORTH, btnMenu_pbc);
		...
		sl_p.putConstraint(SpringLayout.WEST, btnC22, 456, SpringLayout.EAST, btnET);
		sl_p.putConstraint(SpringLayout.EAST, btnC22, -456, SpringLayout.EAST, p);
		sl_p.putConstraint(SpringLayout.NORTH, btnC22, 9, SpringLayout.NORTH, btnET);
		sl_p.putConstraint(SpringLayout.SOUTH, btnC22, -64, SpringLayout.SOUTH, p);
		btnC22.setIcon(new ImageIcon(planta_baja_calefaccion.class.getResource("/imagenes/calefaccion.png")));
		...
		sl_p.putConstraint(SpringLayout.WEST, lblB21, 490, SpringLayout.EAST, btnMenu_pbc);
		p.add(lblB21);

		JLabel lblB22 = new JLabel("22");
		sl_p.putConstraint(SpringLayout.NORTH, lblB22, 4, SpringLayout.NORTH, btnMenu_pbc);
